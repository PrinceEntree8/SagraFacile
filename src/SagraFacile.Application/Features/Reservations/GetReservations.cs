...
{
    public record Query(int EventId, string? Status = null, int Page = 1, int PageSize = 50) : IQuery<Result>;
    ...
    public class Handler : IQueryHandler<Query, Result>
    {
        ...
        public async Task<Result> Handle(Query query, CancellationToken cancellationToken)
        {
            ...
            var (items, total) = await _repository.GetPagedAsync(query.EventId, query.Status, query.Page, query.PageSize, cancellationToken);
