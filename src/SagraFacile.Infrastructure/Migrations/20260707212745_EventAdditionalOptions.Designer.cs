...
namespace SagraFacile.Infrastructure.Migrations
{
    ...
    [Migration("20260707212745_EventAdditionalOptions")]
    partial class EventAdditionalOptions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SagraFacile.Domain.Features.Events.Event", b =>
                {
                    ...
                    b.Property<string>("AdditionalOptions")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValue("{\"reservations\":{\"partyCompletion\":{\"enabled\":false,\"minPartySize\":8}},\"view\":{\"showNotesField\":false,\"counterPeopleFirst\":true,\"showCallCount\":false,\"maxWaitTimeMinutes\":45}}");
