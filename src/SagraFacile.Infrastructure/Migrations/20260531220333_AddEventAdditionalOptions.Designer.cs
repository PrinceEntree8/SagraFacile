...
namespace SagraFacile.Infrastructure.Migrations
{
    ...
    [Migration("20260531220333_AddEventAdditionalOptions")]
    partial class AddEventAdditionalOptions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SagraFacile.Domain.Features.Events.Event", b =>
                {
                    ...
                    b.Property<string>("AdditionalOptions")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValue("{\"reservations\":{\"partyCompletion\":{\"enabled\":false,\"minPartySize\":8}}}");
