...
namespace SagraFacile.Infrastructure.Migrations
{
    ...
    [Migration("20260805164330_AddOrderLifecycle")]
            ...
            modelBuilder.Entity("SagraFacile.Domain.Features.Orders.Order", b =>
                {
                    ...
                    b.HasOne("SagraFacile.Domain.Features.Orders.Order", "Parent")
                        .WithMany("FollowUps")
